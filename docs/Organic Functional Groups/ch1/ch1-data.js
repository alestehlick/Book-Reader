          ...
          "visuals": [
            {
              ...
              "label": "Figure 1.6",
              "kind": "figure",
              "caption": "Contour plots of the bonding and antibonding molecular orbitals of \\( \\mathrm{H}_2 \\). The main point is the contrast between inward drawn density in the bonding case and outward displaced density in the antibonding case."
            },
            {
              "id": "fig-1.7",
              "label": "Figure 1.7",
              "kind": "figure",
              "caption": "Plots of \\( \\psi^2 \\) for the \\( \\mathrm{H}_2 \\) molecular orbitals along the internuclear axis, compared with the isolated atomic densities. They show directly how bonding increases density in the middle, whereas antibonding removes it."
            }
          ],
          "equations": [],
          "videos": []
